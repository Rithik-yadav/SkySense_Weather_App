...
import in.rithik.weatherwidget.BuildConfig;
import in.rithik.weatherwidget.R;
import in.rithik.weatherwidget.adapters.SettingsAdapter;
import in.rithik.weatherwidget.interfaces.SingleChoiceDialog;
import in.rithik.weatherwidget.utils.SettingsItems;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    private ArrayList<SettingsItems> getData() {
        ...
        mData.add(new SettingsItems(getString(R.string.app_name) + " " + BuildConfig.VERSION_NAME + " ("
                + BuildConfig.VERSION_CODE + ")", "MAD Group-1",
        ...
        mData.add(new SettingsItems(getString(R.string.source_code), getString(R.string.source_code_summary),
                Utils.getDrawable(R.drawable.ic_github, this), "https://www.youtube.com/"));
        return mData;
    }
