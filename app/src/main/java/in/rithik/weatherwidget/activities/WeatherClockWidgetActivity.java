...
import in.rithik.weatherwidget.adapters.WeatherClockWidgetAdapter;
...
public class WeatherClockWidgetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new AcquireWeatherData(Weather.getLatitude(this), Weather.getLongitude(this), this) {
            ...
            public void successLister(List<WeatherItems> weatherItems) {
                mRecyclerView.setAdapter(new WeatherClockWidgetAdapter(weatherItems, mAppWidgetId, WeatherClockWidgetActivity.this));
            }
        }.acquire();
    }
